...
export const state: StateType = {
    productData: [
        ...
        { productID: 'b120c5f3-5a97-11ed-90f4-532a5dca7d1c', productName: 'iPad', productDescription: 'bla-bla-bla',productPhoto: iPad, productPrice: 1300, productCount: 10, productCategories: {type: "iPad"}, productArticle: 'MLW33RK/A'},
        { productID: 'b120c5f4-5a97-11ed-90f4-532a5dca7d1c', productName: 'iWatch series 7', productDescription: 'bla-bla-bla',productArticle: '2QMG143' ,productPhoto: Watch, productPrice: 500, productCount: 10, productCategories: {type: "Watch"}},
        { productID: 'b120c5f5-5a97-11ed-90f4-532a5dca7d1c', productName: 'MacBook', productDescription: 'bla-bla-bla',productPhoto:MacBook, productPrice: 1100, productCount: 10, productCategories: {type: "MacBook"}, productArticle: 'MK193RU/A'},
        ...
        { productID: 'b120c5f7-5a97-11ed-90f4-532a5dca7d1c', productName: 'Apple TV', productDescription: 'bla-bla-bla',productPhoto:TV, productPrice: 2100, productCount: 11, productCategories: {type: "TV"}, productArticle: 'MK193RU/TV'},
